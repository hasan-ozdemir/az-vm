...
function Invoke-AzVmStep1Common {
    ...
    $shortcutSocialBusinessLinkedInUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_LINKEDIN_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessYouTubeUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_YOUTUBE_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessGitHubUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_GITHUB_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessTikTokUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_TIKTOK_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessInstagramUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_INSTAGRAM_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessFacebookUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_FACEBOOK_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessXUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_X_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessSnapchatUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_SNAPCHAT_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialBusinessNextSosyalUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_BUSINESS_NEXTSOSYAL_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialPersonalLinkedInUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_PERSONAL_LINKEDIN_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialPersonalYouTubeUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_PERSONAL_YOUTUBE_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialPersonalGitHubUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_PERSONAL_GITHUB_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialPersonalTikTokUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_PERSONAL_TIKTOK_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialPersonalInstagramUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_PERSONAL_INSTAGRAM_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialPersonalFacebookUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_PERSONAL_FACEBOOK_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutSocialPersonalXUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_SOCIAL_PERSONAL_X_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutWebBusinessHomeUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_WEB_BUSINESS_HOME_URL' -DefaultValue '')) -Tokens $baseTokens
    $shortcutWebBusinessBlogUrl = Resolve-AzVmTemplate -Template ([string](Get-ConfigValue -Config $ConfigMap -Key 'WIN_PUBLIC_SHORTCUT_WEB_BUSINESS_BLOG_URL' -DefaultValue '')) -Tokens $baseTokens
