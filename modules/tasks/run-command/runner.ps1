...
function New-AzVmRunCommandTaskWrapperScript {
    ...
    [void]$builder.AppendLine('        $nestedScript = ''$ErrorActionPreference = "Stop"'' + [Environment]::NewLine + ''$ProgressPreference = "SilentlyContinue"'' + [Environment]::NewLine + $decodedScript')
    ...
    [void]$builder.AppendLine('        }')
    [void]$builder.AppendLine('        if ($process.ExitCode -ne 0) {')
