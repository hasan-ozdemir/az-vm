...
$script:TaskMap = @{
    ...
    'microsoft-edge' = '103-install-edge-browser'
    'vscode' = '119-install-vscode-system'
    'docker-desktop' = '131-install-docker-desktop'
    'wsl' = '121-install-wsl2-system'
    'ollama' = '133-install-ollama-system'
    'azure-cli' = '127-install-azure-cli'
    'azd' = '109-install-azd-cli'
    'gh-cli' = '108-install-gh-cli'
    'rclone' = '106-install-rclone-system'
    'google-drive' = '126-install-google-drive'
    'onedrive' = '104-install-onedrive-system'
    'vlc' = '128-install-vlc-system'
    'nvda' = '118-install-nvda-system'
    'jaws' = '130-install-jaws-screen-reader'
    'anydesk' = '110-install-anydesk-system'
    'itunes' = '120-install-itunes-system'
    'icloud' = '122-install-icloud-system'
    'teams' = '105-install-teams-system'
    'whatsapp' = '116-install-whatsapp-system'
    'codex-app' = '117-install-codex-app'
    'be-my-eyes' = '115-install-be-my-eyes'
    'windscribe' = '113-install-windscribe-system'
    'vs2022community' = '129-install-vs2022community'
}
