...
function Show-AzVmCommandHelpOverview {
    ...
    Write-Host "  az-vm do --vm-action=hibernate-deallocate --group=rg-examplevm-ate1-g1 --vm-name=examplevm"
...
function Show-AzVmCommandHelpDetailed {
    ...
    switch ($topicName) {
        ...
        'do' {
            ...
            Write-Host "Usage:"
            Write-Host "  az-vm do [--group=<resource-group>] [--vm-name=<vm-name>] [--vm-action=<status|start|restart|stop|deallocate|hibernate-deallocate>] [--perf]"
