...
Write-Host "Update task started: configure-settings-advanced-system"
...
Write-Host "configure-settings-advanced-system-completed"
Write-Host "Update task completed: configure-settings-advanced-system"
