...
Write-Host "Update task started: install-microsoft-teams"
...
Write-Host "install-microsoft-teams-completed"
Write-Host "Update task completed: install-microsoft-teams"
