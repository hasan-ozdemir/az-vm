...
Invoke-ShortcutAction -Name "local-only-shortcut" -Action { New-DesktopShortcut -Name "local-only-shortcut" -TargetPath $localOnlyAccessibilityExe -Hotkey "Ctrl+Shift+J" }
