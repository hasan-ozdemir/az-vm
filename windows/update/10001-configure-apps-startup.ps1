...
Write-Host "Update task started: configure-apps-startup"
...
Write-Host 'configure-apps-startup-completed'
Write-Host "Update task completed: configure-apps-startup"
