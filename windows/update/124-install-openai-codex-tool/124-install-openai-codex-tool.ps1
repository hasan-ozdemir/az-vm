...
Write-Host "Update task started: install-openai-codex-tool"
...
$taskConfig = [ordered]@{
    TaskName = 'install-openai-codex-tool'
...
Write-Host "install-openai-codex-tool-completed"
Write-Host "Update task completed: install-openai-codex-tool"
