...
- Extended `tests/quality-audit.ps1` to include documentation contract checks and an optional Linux shell syntax skip path for fast local and CI execution.
